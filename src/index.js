...
var group_controllers_1 = require("./controllers/group.controllers");
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, (0, message_controllers_1.createMessage)({
                            idUser: data.idUser,
...
// listen
server.listen(config_1.config.port || 3000, function () {
